...
export default function Navbar() {
  ...
  // Text link style (Gallery/Admin/Logout/Login)
  const navLink =
  ...
  // Cart button: light, with icon
  const cartBtn =
    "px-3 py-2 rounded-lg text-sm font-medium border-gray-400 text-gray-900 hover:bg-gray-200 transition flex items-center gap-2";
    ...
    <header className="sticky top-0 z-10 bg-white/80 backdrop-blur border-b w-full">
      <div className="mx-auto w-full max-w-7xl px-4 py-3">
        ...
        <nav className="mt-3 flex flex-col gap-2 sm:mt-0 sm:flex-row sm:items-center sm:justify-end sm:gap-4">
          ...
          {/* Cart: outlined button with icon + count */}
          <Link
          to="/cart"
